...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'MailSlurpModels/EmailPreview', 'MailSlurpModels/Inbox', 'MailSlurpModels/SendEmailOptions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../MailSlurpModels/EmailPreview'), require('../MailSlurpModels/Inbox'), require('../MailSlurpModels/SendEmailOptions'));
  } else {
    // Browser globals (root is window)
    if (!root.MailslurpSwaggerSdk) {
      root.MailslurpSwaggerSdk = {};
    }
    root.MailslurpSwaggerSdk.InboxControllerApi = factory(root.MailslurpSwaggerSdk.ApiClient, root.MailslurpSwaggerSdk.EmailPreview, root.MailslurpSwaggerSdk.Inbox, root.MailslurpSwaggerSdk.SendEmailOptions);
  }
}(this, function(ApiClient, EmailPreview, Inbox, SendEmailOptions) {
  'use strict';

  /**
   * InboxController service.
   * @module MailSlurpApi/InboxControllerApi
   * @version 0.0.1-alpha
   */

  /**
   * Constructs a new InboxControllerApi. 
   * @alias module:MailSlurpApi/InboxControllerApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:MailSlurpModels/Inbox} and HTTP response
     */
    this.createInboxUsingPOSTWithHttpInfo = function() {
      var postBody = null;
     ...
     * Create Inbox
     * Create a new ephemeral email address to send and receive from
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:MailSlurpModels/Inbox}
     */
    this.createInboxUsingPOST = function() {
      return this.createInboxUsingPOSTWithHttpInfo()
     ...
     */
    this.deleteInboxUsingDELETEWithHttpInfo = function(id) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteInboxUsingDELETE");
      }
     ...
     */
    this.deleteInboxUsingDELETE = function(id) {
      return this.deleteInboxUsingDELETEWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id Id of inbox that emails belongs to
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit Limit the result set, ordered by descending received date time
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:MailSlurpModels/EmailPreview>} and HTTP response
     */
    this.getEmailsUsingGETWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getEmailsUsingGET");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = [EmailPreview];

      return this.apiClient.callApi(
        '/inboxes/{id}/emails', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {Number} opts.retryTimeout Maximum milliseconds to spend retrying inbox database until minCount emails are returned
     * @param {Date} opts.since Exclude emails received before this ISO 8601 date time
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:MailSlurpModels/EmailPreview>}
     */
    this.getEmailsUsingGET = function(id, opts) {
      return this.getEmailsUsingGETWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:MailSlurpModels/Inbox} and HTTP response
     */
    this.getInboxUsingGETWithHttpInfo = function(id) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getInboxUsingGET");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:MailSlurpModels/Inbox}
     */
    this.getInboxUsingGET = function(id) {
      return this.getInboxUsingGETWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * List Inboxes
     * List your inboxes
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:MailSlurpModels/Inbox>} and HTTP response
     */
    this.getInboxesUsingGETWithHttpInfo = function() {
      var postBody = null;
     ...
     * List Inboxes
     * List your inboxes
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:MailSlurpModels/Inbox>}
     */
    this.getInboxesUsingGET = function() {
      return this.getInboxesUsingGETWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id id
     * @param {module:MailSlurpModels/SendEmailOptions} sendEmailOptions sendEmailOptions
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.sendEmailUsingPOSTWithHttpInfo = function(id, sendEmailOptions) {
      var postBody = sendEmailOptions;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling sendEmailUsingPOST");
      }

      // verify the required parameter 'sendEmailOptions' is set
      if (sendEmailOptions === undefined || sendEmailOptions === null) {
        throw new Error("Missing the required parameter 'sendEmailOptions' when calling sendEmailUsingPOST");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.sendEmailUsingPOST = function(id, sendEmailOptions) {
      return this.sendEmailUsingPOSTWithHttpInfo(id, sendEmailOptions)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
