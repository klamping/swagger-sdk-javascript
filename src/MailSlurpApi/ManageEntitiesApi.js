...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'MailSlurpModels/Inbox'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../MailSlurpModels/Inbox'));
  } else {
    // Browser globals (root is window)
    if (!root.MailslurpSwaggerSdk) {
      root.MailslurpSwaggerSdk = {};
    }
    root.MailslurpSwaggerSdk.ManageEntitiesApi = factory(root.MailslurpSwaggerSdk.ApiClient, root.MailslurpSwaggerSdk.Inbox);
  }
}(this, function(ApiClient, Inbox) {
  'use strict';

  /**
   * ManageEntities service.
   * @module MailSlurpApi/ManageEntitiesApi
   * @version 0.0.1-alpha
   */

  /**
   * Constructs a new ManageEntitiesApi. 
   * @alias module:MailSlurpApi/ManageEntitiesApi
   * @class
