...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'MailSlurpModels/Email', 'MailSlurpModels/EmailAnalytics', 'MailSlurpModels/EmailPreview', 'MailSlurpModels/Inbox'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../MailSlurpModels/Email'), require('../MailSlurpModels/EmailAnalytics'), require('../MailSlurpModels/EmailPreview'), require('../MailSlurpModels/Inbox'));
  } else {
    // Browser globals (root is window)
    if (!root.MailslurpSwaggerSdk) {
      root.MailslurpSwaggerSdk = {};
    }
    root.MailslurpSwaggerSdk.ReceiveEmailsApi = factory(root.MailslurpSwaggerSdk.ApiClient, root.MailslurpSwaggerSdk.Email, root.MailslurpSwaggerSdk.EmailAnalytics, root.MailslurpSwaggerSdk.EmailPreview, root.MailslurpSwaggerSdk.Inbox);
  }
}(this, function(ApiClient, Email, EmailAnalytics, EmailPreview, Inbox) {
  'use strict';

  /**
   * ReceiveEmails service.
   * @module MailSlurpApi/ReceiveEmailsApi
   * @version 0.0.1-alpha
   */

  /**
   * Constructs a new ReceiveEmailsApi. 
   * @alias module:MailSlurpApi/ReceiveEmailsApi
   * @class
