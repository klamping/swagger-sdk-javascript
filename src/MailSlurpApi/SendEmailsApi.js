...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'MailSlurpModels/Inbox', 'MailSlurpModels/SendEmailOptions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../MailSlurpModels/Inbox'), require('../MailSlurpModels/SendEmailOptions'));
  } else {
    // Browser globals (root is window)
    if (!root.MailslurpSwaggerSdk) {
      root.MailslurpSwaggerSdk = {};
    }
    root.MailslurpSwaggerSdk.SendEmailsApi = factory(root.MailslurpSwaggerSdk.ApiClient, root.MailslurpSwaggerSdk.Inbox, root.MailslurpSwaggerSdk.SendEmailOptions);
  }
}(this, function(ApiClient, Inbox, SendEmailOptions) {
  'use strict';

  /**
   * SendEmails service.
   * @module MailSlurpApi/SendEmailsApi
   * @version 0.0.1-alpha
   */

  /**
   * Constructs a new SendEmailsApi. 
   * @alias module:MailSlurpApi/SendEmailsApi
   * @class
