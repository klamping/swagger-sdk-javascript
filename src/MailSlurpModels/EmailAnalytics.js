...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MailslurpSwaggerSdk.EmailAnalytics = factory(root.MailslurpSwaggerSdk.ApiClient);
  }
  ...
  /**
   * The EmailAnalytics model module.
   * @module MailSlurpModels/EmailAnalytics
   * @version 0.0.1-alpha
   */

  /**
   * Constructs a new <code>EmailAnalytics</code>.
   * Analysis of an email message and its contents
   * @alias module:MailSlurpModels/EmailAnalytics
   * @class
   * @param spamNegativityPercentage {Number} 
   */
  var exports = function(spamNegativityPercentage) {
    var _this = this;

    _this['spamNegativityPercentage'] = spamNegativityPercentage;
  };

  /**
   * Constructs a <code>EmailAnalytics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:MailSlurpModels/EmailAnalytics} obj Optional instance to populate.
   * @return {module:MailSlurpModels/EmailAnalytics} The populated <code>EmailAnalytics</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('spamNegativityPercentage')) {
        obj['spamNegativityPercentage'] = ApiClient.convertToType(data['spamNegativityPercentage'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Number} spamNegativityPercentage
   */
  exports.prototype['spamNegativityPercentage'] = undefined;
