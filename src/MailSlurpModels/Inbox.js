...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MailslurpSwaggerSdk.Inbox = factory(root.MailslurpSwaggerSdk.ApiClient);
  }
   ...
   * @alias module:MailSlurpModels/Inbox
   * @class
   */
   ...
   * @param {module:MailSlurpModels/Inbox} obj Optional instance to populate.
   * @return {module:MailSlurpModels/Inbox} The populated <code>Inbox</code> instance.
   */
