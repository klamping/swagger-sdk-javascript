...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpSwaggerSdk.EmailPreview();
  });
  ...
  describe('EmailPreview', function() {
    it('should create an instance of EmailPreview', function() {
      ...
      //var instance = new MailslurpSwaggerSdk.EmailPreview();
      //expect(instance).to.be.a(MailslurpSwaggerSdk.EmailPreview);
    });
