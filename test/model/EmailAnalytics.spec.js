...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpSwaggerSdk.EmailAnalytics();
  });
  ...
  describe('EmailAnalytics', function() {
    it('should create an instance of EmailAnalytics', function() {
      // uncomment below and update the code to test EmailAnalytics
      //var instance = new MailslurpSwaggerSdk.EmailAnalytics();
      //expect(instance).to.be.a(MailslurpSwaggerSdk.EmailAnalytics);
    });

    it('should have the property spamNegativityPercentage (base name: "spamNegativityPercentage")', function() {
      // uncomment below and update the code to test the property spamNegativityPercentage
      //var instance = new MailslurpSwaggerSdk.EmailAnalytics();
