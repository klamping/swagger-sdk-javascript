...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpSwaggerSdk.SendEmailOptions();
  });
  ...
  describe('SendEmailOptions', function() {
    it('should create an instance of SendEmailOptions', function() {
      ...
      //var instance = new MailslurpSwaggerSdk.SendEmailOptions();
      //expect(instance).to.be.a(MailslurpSwaggerSdk.SendEmailOptions);
    });
