...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpSwaggerSdk.InboxControllerApi();
  });
  ...
  describe('InboxControllerApi', function() {
    describe('createInboxUsingPOST', function() {
      it('should call createInboxUsingPOST successfully', function(done) {
        //uncomment below and update the code to test createInboxUsingPOST
        //instance.createInboxUsingPOST(function(error) {
    ...
    describe('getInboxUsingGET', function() {
      it('should call getInboxUsingGET successfully', function(done) {
        //uncomment below and update the code to test getInboxUsingGET
        //instance.getInboxUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInboxesUsingGET', function() {
      it('should call getInboxesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getInboxesUsingGET
        //instance.getInboxesUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
